...
# =====================================================
# 🔹 Сервис: проверка доступа к уровню челленджей
#     Определяет, открыт ли уровень на основе ⭐ пользователя.
#     - бизнес-логика
#     - не содержит SQL
...
# =====================================================
# 🔹 Сервис: получение общей информации об уровнях
#     Возвращает:
#       • сколько у пользователя ⭐
#       • названия уровней
#     - никакого SQL здесь нет
#     - вся логика обращения к БД вынесена в репозиторий
# =====================================================
...
# =====================================================
# 🔹 Сервис: сбор всех данных по челленджам уровня
#     Возвращает:
#       • список челленджей уровня
#       • список активных челленджей
#       • список завершённых челленджей
#       • мапу сложностей
#     - бизнес-логика подготовки данных
#     - вся работа с БД идёт через репозиторий
# =====================================================
...
# =====================================================
# 🔹 Сервис: определение сложности челленджа
#     • 0 повторов → сложность 1
#     • 1 повтор → сложность 2
#     • 2+ повторов → сложность 3
...
# =====================================================
# 🔹 Сервис: определение длительности челленджа
#     • первый раз: 7 дней
#     • второй раз: 10 дней
#     • третий раз: 14 дней
#     - чистая бизнес-логика
...
# =====================================================
# 🔹 Сервис: активация челленджа
#     • считает сложность
#     • считает длительность
#     • подбирает описание
#     • отправляет в репозиторий для записи
#     - не содержит SQL
