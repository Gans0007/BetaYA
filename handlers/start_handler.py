...
def welcome_text(nickname: str | None = None) -> str:
    ...
    return (
        ...
        "TrackerYA — система привычек, челленджей и дисциплины.\n\n"

        "<b>📌 Как начать:</b>\n"
        "1️⃣ Нажми «➕ Добавить привычку / челлендж»\n"
        "2️⃣ Создай свою первую привычку\n"
        "3️⃣ Подтверждай выполнение каждый день в «Активные привычки»\n"
        "4️⃣ Получай XP, звёзды и повышай свою лигу\n\n"

        "<b>Мини-приложение (кнопка Play):</b>\n"
        "• статистика и прогресс\n"
        "• рейтинг участников\n"
        "• готовые челленджи\n"
        "• группы и сообщества\n"
        "• друзья и их прогресс\n\n"

        "Все подтверждения публикуются в общем чате:\n"
        "👉 <a href=\"https://t.me/yourambitions_chat\">перейти в чат</a>\n\n"

        "⬇️ Начни с создания первой привычки или челленджа."
    )
