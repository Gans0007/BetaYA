...
# -------------------------------
LEVEL_QUOTES = {
    "level_0": "«Если ты думаешь что это так просто, то почему все еще не начал?!» 💫",
...
CHALLENGES = {
    "level_0": [
        ("0_reading", "Чтение", "Читать 1 страницу каждый день на протяжении 7 дней. Не думай что это просто!", 7, "media"),
        ("0_walking", "Прогулка", "Выходить на 1 минутную прогулку в течении 7 дней.", 7, "media"),
        ...
        ("0_pullups", "Подтягивания", "Подтянись несколько раз для развития спины и рук", 30, "media"),
        ("0_squats", "Приседания", "Сделай серию приседаний для ног и выносливости", 7, "media"),
        ("0_plank", "Планка", "Удерживай планку для силы кора и концентрации", 7, "media"),
        ("0_jumps", "Выпрыгивания", "Сделай серию выпрыгиваний для энергии и силы", 7, "media"),
        ("0_splits", "Шпагат", "Растянись и попробуй сесть на шпагат", 7, "media"),
        ("0_any_activity", "Физическая активность", "Обязательная любая физ активность — главное, чтобы тело двигалось", 7, "media"),
    ],
    "level_1": [
